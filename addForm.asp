...
'基本设置，定义表单控件变量
Dim s_SN,OneCatID,TwoCatID,ProjectName,ProductManager,Designer,FrontEnd,Developer,SVNURL,TerminalPC,TerminalMobi,BrowserPC,BrowserMobi,Cycle,StartCycle,EndCycle,Timelimit,Direction,AddDate,EditDate,IsTop,IsState
s_SN="P"&right(year(Now()),2)&right("0"&month(Now()),2)&right("0"&day(Now()),2)&right("0"&hour(Now()),2)&right("0"&minute(Now()),2)&right("0"&second(Now()),2)
OneCatID = 0
TwoCatID = 0
Title = Trim(Request.Form("Title"))
ProductManager = Trim(Request.Form("ProductManager"))
Designer = Trim(Request.Form("Designer"))
FrontEnd = Trim(Request.Form("FrontEnd"))
Developer = Trim(Request.Form("Developer"))
SVNURL = Trim(Request.Form("SVNURL"))
TerminalPC = Trim(Request.Form("TerminalPC"))
TerminalMobi = Trim(Request.Form("TerminalMobi"))
BrowserPC = Trim(Request.Form("BrowserPC"))
BrowserMobi = Trim(Request.Form("BrowserMobi"))
Cycle = Request.Form("Cycle")
StartCycle = SplitArray(Cycle,",")(0)
EndCycle = SplitArray(Cycle,",")(1)
Direction = Trim(Request.Form("Direction"))
EditDate = Now()
%><!DOCTYPE html>
    ...
    <body>
                ...
                <form id="mainForm" name="mainForm" method="post">
                    <div class="panel-heading no-padding">
                        <h4 class="bg-primary form-group form-group-flex vertical clear-text padding no-margin">
                            <label for="Title"><i class="glyphicon glyphicon-th-list"></i></label>
                            <div class="col margin-left">
                                <input type="text" class="form-control field-input" id="Title" name="Title" placeholder="请输入项目名称">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-group form-group-flex vertical">
                                ...
                                <div id="FileList" class="col alert-group"></div>
                            </div>
                        </div>
                        <div class="row">
        ...
        Sub SaveData()
            ...
            If Not(Rs.eof And Rs.bof) Then
                Response.Write "<script>alert('您准备提交的信息：“"&Title&"”已存在！');history.go(-1);</script>"
                Call ConnClose(Conn)
                Exit Sub
            Else
                Rs.AddNew
